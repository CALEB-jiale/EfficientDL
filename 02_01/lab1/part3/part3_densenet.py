...
rootdir = '/users/local/data/cifar100'
...
backbone_weights_path = '/homes/x21ye/lab1/pretrained_models_cifar100/DenseNet121_model_cifar100_lr_0.01.pth'

net = models_cifar100.DenseNet121()
...
# PATH_Loss = '/homes/x21ye/lab1/data_log/densenet_cifar100_net_training_loss.npy'
# np.save(PATH_Loss, training_losses)

# PATH = '/homes/x21ye/lab1/nets/densenet_cifar100_net.pth'
...
PATH_Accuracies = '/homes/x21ye/lab1/data_log/densenet_cifar100_net_accuracies.npy'
