...
densenet_accuracy_cifar10 = np.load(
    PATH + "/data_log/densenet_cifar_net_accuracies.npy")
preact_resnet_accuracy_cifar10 = np.load(
    PATH + "/data_log/preact_resnet_cifar_net_accuracies.npy")
resnet_accuracy_cifar10 = np.load(
    PATH + "/data_log/resnet_cifar_net_accuracies.npy")
vgg_accuracy_cifar10 = np.load(PATH + "/data_log/vgg_cifar_net_accuracies.npy")

# Accuracies for cifar 100
densenet_accuracy_cifar100 = np.load(
    PATH + "/data_log/densenet_cifar100_net_accuracies.npy")
preact_resnet_accuracy_cifar100 = np.load(
    PATH + "/data_log/preact_resnet_cifar100_net_accuracies.npy")
resnet_accuracy_cifar100 = np.load(
    PATH + "/data_log/resnet_cifar100_net_accuracies.npy")
vgg_accuracy_cifar100 = np.load(
    PATH + "/data_log/vgg_cifar100_net_accuracies.npy")

# Training loss for cifar 10
densenet_loss_cifar10 = np.load(
    PATH + "/data_log/densenet_cifar_net_training_loss.npy")
preact_resnet_loss_cifar10 = np.load(
    PATH + "/data_log/preact_resnet_cifar_net_training_loss.npy")
resnet_loss_cifar10 = np.load(
    PATH + "/data_log/resnet_cifar_net_training_loss.npy")
