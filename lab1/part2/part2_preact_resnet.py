...
PATH_Loss = '/homes/x21ye/lab1/data_log/preact_resnet_cifar_net_training_loss.npy'
np.save(PATH_Loss, training_losses)

PATH = '/homes/x21ye/lab1/nets/preact_resnet_cifar_net.pth'
...
PATH_Accuracies = '/homes/x21ye/lab1/data_log/preact_resnet_cifar_net_accuracies.npy'
